...
public class MyActivity extends AppCompatActivity {
    ...
    public final static String MARK = "com.mycompany.myfirstapp.MARK";
...
//        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    public void test(View view){
        ...
        db.execSQL("CREATE TABLE Output (id INTEGER PRIMARY KEY AUTOINCREMENT, random_num VARCHAR, enter_num VARCHAR, mistake INTEGER, time FLOAT, test Integer)");
    }
