...
public class LockSetupActivity extends Activity implements
    ...
    private static final int STEP_2 = 2; // Gesture initialize
    private static final int STEP_3 = 3; // Press Continue
    private static final int STEP_4 = 4; // Gesture confirmed
